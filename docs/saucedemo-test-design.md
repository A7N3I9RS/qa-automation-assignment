...
| [authentication.spec.ts](../tests/saucedemo/authentication.spec.ts) | Catalog opens within accepted time after login                 | Users with access | Products page opens within `CATALOG_LOAD_TIME_LIMIT_MS` after login submit                       |
