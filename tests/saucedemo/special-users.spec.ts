...
test.describe('SauceDemo common user behavior matrix', () => {
  ...
  test.describe('Checkout form data', () => {
    for (const username of shoppingUsers) {
  ...
  test.describe('Locked-out login', () => {
